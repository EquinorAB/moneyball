...
module ::Units::Utils::ChainGenerator
  ...
  class BlockFactory
    ...
    def initialize(developer_fund, skip_official_nodes, custom_official_nodes, memory_kind = MemoryKind::SINGLE)
      ...
      @miner = Axentro::Core::NodeComponents::Miner.new(MockWebSocket.new, "535061bddb0549f691c8b9c012a55ee2", @blockchain.mining_block.difficulty, "127.0.0.1", 0, "name", "address")
